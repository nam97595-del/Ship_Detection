...
if __name__ == "__main__":
    ...
    GT_PATH = os.path.join(mot_dir, "1.1(2).txt")   # File gán nhãn bằng DarkLabel
    PRED_PATH = os.path.join(mot_dir, "pred_1.1_20260322_145012.txt") # File yolo_engine.py xuất ra
