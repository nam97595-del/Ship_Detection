...
class App(tk.Tk):
    ...
    def create_widgets(self):
        ...
        cb_tracker_type = ttk.Combobox(frame_arch, textvariable=self.var_tracker_type, values=["ByteTrack", "DeepOcSort", "BoT-SORT", "StrongSORT", "BoostTrack", "HybridSort", "OcSort", "SfSort"], state="readonly", width=15)
